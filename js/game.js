...
var displayPopup = function (playerName) {
    ...
    if (saving) {
        ...
        if (playerName) {
            ...
            popupWinner.innerHTML = 'No one won, is aTie';
            postWin();
        }
    }
    stopTimers();
...
var getPlayerNames = function () {
    if (isNewGame) {
        ...
        p1Name.innerHTML = savedGames[savedGameIndex].p1.name;
        p2Name.innerHTML = savedGames[savedGameIndex].p2.name;
    }
}
...
var changeTurnIcon = function () {
    if (turn === 'p1') {
        turnTab.src = 'assets/svg/redtab.svg'
    } else if (turn === 'p2') {
        turnTab.src = 'assets/svg/bluetab.svg'
    }
}
...
var initialize = function () {
    ...
    if (isNewGame) {
        p1.name = p1Name.innerHTML.slice(0);
        p2.name = p2Name.innerHTML.slice(0);
